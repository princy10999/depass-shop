...
import {removeFromCartAction} from "../../store/actions/remove-cart.action";
                                                                    ...
                                                                    <div className="ml-4 flex flex-1 flex-col">
                                                                        <div>
                                                                            <div
                                                                                ...
                                                                                <p className="ml-4">${item.regularPrice}</p>
                                                                            </div>
                                                                            <p className="mt-1 text-sm text-gray-500">{item.regularPrice}</p>
                                                                        </div>
                                                                        <div
